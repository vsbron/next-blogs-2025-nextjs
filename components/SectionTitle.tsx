...
const beforeElement = `before:content-[""] before:absolute before:bg-accent before:rounded-md before:sm:rounded-lg before:left-0 before:top-1.75 before:xs:top-1.5`;
